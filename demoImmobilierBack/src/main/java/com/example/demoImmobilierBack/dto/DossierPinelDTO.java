...
public class DossierPinelDTO {
	...
	public ResultatLoiPinelDTO getResultatLoiPinelDTO() {
		return resultatLoiPinelDTO;
	}

	public void setResultatLoiPinelDTO(ResultatLoiPinelDTO resultatLoiPinelDTO) {
		this.resultatLoiPinelDTO = resultatLoiPinelDTO;
	}
